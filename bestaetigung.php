...
<div class="container">
    ...
    <p>
        <?php
        echo "Vielen Dank für Ihre Teilnahme, wir haben folgende Daten gespeichert:<br/><br/>";
        ...
        if ($nachname == "")
        {
            echo "<p style='color:red'> Sie müssen einen Nachnamen angeben!</p>";
        } else
        {
        ...
        if (strlen($plz) != 5 || !is_int($plz))
        {
            echo "<p style='color:red'> Sie müssen eine korrekte Postleitzahl angeben!</p>";
        } else
        {
            echo "PLZ: $plz<br/>";
        }
        ...
        echo "Gewählte Antwort: $antwort<br/>";

        if (isset($_REQUEST['china']))
        {
            echo "Sie bekommen Infos zu unserem Partner China-Express<br/>";
        }
        if (isset($_REQUEST['mt24']))
        {
            echo "Sie bekommen Infos zu unserem Partner Maultasche24<br/>";
        }
        if (isset($_REQUEST['cad']))
        {
            echo "Sie bekommen Infos zu unserem Partner Call-a-Döner<br/>";
        }

        $handle=fopen("daten/teilnehmer.txt","a");
        $temp = "; $nachname; $str; $plz\n";
        fputs($handle, $temp);
        fclose($handle);
        ?>
    </p>
