...
<div class="jumbotron">
    <div class="container">
        ...
        <p>Ihre Pizza wird innerhalb von 20 Minuten geliefert</p>
...
<div class="container">
    ...
    $query = "INSERT INTO `bestellungen` (`vorname`, `nachname`, `str`, `ort`, `plz`, `mail`, `datum`) VALUES ('" . $_SESSION['vorname'] . "', '" . $_SESSION['nachname'] . "', '" . $_SESSION['str'] . "', '" . $_SESSION['ort'] . "', '" . $_SESSION['plz'] . "', '" . $_SESSION['mail'] . "', now());";
    ...
    {
        echo "<p>Fehler: " . mysqli_error($link)."</p>";
    }
