...
CREATE TABLE `bestellungen` (
  ...
  `str` varchar(150) COLLATE latin1_german1_ci NOT NULL,
...
INSERT INTO `bestellungen` (`id`, `vorname`, `nachname`, `str`, `ort`, `plz`, `mail`, `datum`) VALUES
(1, 'Töbiäs', 'Winkel', 'Neulingstraße', 'Walheim', '12345', 'tobias@wal.gov', '2018-10-22 13:06:10'),
(2, '', '', '', '', '', '', '0000-00-00 00:00:00'),
(4, 'Tom', 'Jaschinski', 'Straße', 'Ludwigsburg', '71679', 'tom@web.gov', '0000-00-00 00:00:00'),
(5, 'Tom', 'Jaschinski', 'Straße', 'Ludwigsburg', '71679', 'tom@web.gov', '2018-10-22 13:21:59');
...
CREATE TABLE `pizza` (
  ...
  `vegetarisch` tinyint(4) NOT NULL,
  `bild` varchar(255) COLLATE latin1_german1_ci NOT NULL
...
INSERT INTO `pizza` (`id`, `name`, `beschreibung`, `preis`, `sonderangebot`, `vegetarisch`, `bild`) VALUES
(1, 'Regina', 'mit Tomaten, Mozzarella, Champignons, Kochschinken und Oregano nach original italienischem Rezept (ohne Konservierungsstoffe, nur frische Zutaten)', 5, 0, 0, ''),
(2, 'Margherita', 'mit Tomaten, Mozzarella, Olivenöl und Basilikum nach original italienischem Rezept (ohne Konservierungsstoffe, nur frische Zutaten)', 4, 0, 1, 'grafik/pizza_margherita_thumb.jpg'),
(3, 'Napoli', 'mit Tomaten, Mozzarella, Sardellen, Olivenöl und Oregano  nach original italienischem Rezept (ohne Konservierungsstoffe, nur frische Zutaten)', 6, 0, 1, 'grafik/pizza_magherita_thumb.jpg'),
(4, 'Salami', 'mit Salami, Tomaten, Mozzarella, Olivenöl und Oregano  nach original italienischem Rezept (ohne Konservierungsstoffe, nur frische Zutaten)', 4.4, 1, 0, ''),
(5, 'Prosciutto', 'mit Kochschinken, Tomaten, Mozzarella, Olivenöl und Oregano  nach original italienischem Rezept (ohne Konservierungsstoffe, nur frische Zutaten)', 5.5, 0, 0, ''),
(6, 'Funghi', 'mit Champignons, Tomaten, Mozzarella, Olivenöl und Oregano  nach original italienischem Rezept (ohne Konservierungsstoffe, nur frische Zutaten)', 4.5, 0, 1, ''),
(7, 'Tonno', 'mit Thunfisch, Tomaten, Mozzarella, Olivenöl und Oregano  nach original italienischem Rezept (ohne Konservierungsstoffe, nur frische Zutaten)', 6.6, 0, 1, ''),
(8, 'Hawaii ', 'mit Kochschinken, Ananas, Tomaten, Mozzarella und Olivenöl nach original italienischem Rezept (ohne Konservierungsstoffe, nur frische Zutaten)', 5.5, 0, 0, '');
